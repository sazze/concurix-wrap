  ...
  var wrapperState = {
    ...
    computeFunctionInfo: function computeFunctionInfo(){
      ...
      if( typeof v8debug != "undefined" ){
        ...
        funInfo.loc = v8debug.Debug.findFunctionSourceLocation(cxOrigFuncToWrap);
        funInfo.id = funInfo.file + ":" + loc.position;
      } else {
        // do not wrap native code or extensions
    ...
    getProxy: function getProxy(){
      var concurixProxy = function() {
        ...
        console.log("about to try original funciton", state);
        try{
          block_tracing = false;
